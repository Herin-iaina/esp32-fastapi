...
##### "Je veux développer"
→ [Architecture](#architecture) + code source
...
- **Troubleshooting données**: [Troubleshooting](#troubleshooting)
...
- **Détails techniques**: [Persistence Guide](#persistence-guide)
...
- ✅ [User Guide](#user-guide) - Guide complet utilisateur
- ✅ [Test Plan](#test-plan) - Plan de test détaillé
...
Ce fichier `README.md` contient maintenant l'ensemble de la documentation utilisateur et développeur.
Pour la configuration avancée et le déploiement, voir [CONFIGURATION.md](CONFIGURATION.md).
...
|---------|------|----------|-------------|
| **README.md** | 📄 Docs | Tous | Documentation centralisée |
| **CONFIGURATION.md** | ⚙️ Config | Admin/Dev | Variables d'environnement et déploiement |
| **start.sh** | 🚀 Script | Tous | Démarrer l'app |
| **stop.sh** | 🛑 Script | Tous | Arrêter l'app |
| **verify.sh** | ✔️ Script | Admin | Vérifier l'installation |
...
1. Lire: [User Guide](#user-guide)
2. Démarrer: `./start.sh`
3. Accéder: http://localhost:8000
4. Aide: [Troubleshooting](#troubleshooting)
...
1. Lire: [README](#readme)
2. Comprendre: [Architecture](#architecture)
3. Coder: Voir les fichiers source
4. Tester: [Test Plan](#test-plan)
5. Documenter: Mettre à jour ce fichier

##### "Ça ne marche pas"
1. Lire: [Troubleshooting](#troubleshooting)
...
##### Problème Technique?
→ Voir [Troubleshooting](#troubleshooting)

##### Question Utilisateur?
→ Voir [User Guide](#user-guide)
